						...
						for(int i=0; i<foundchest.getSizeInventory();i++){
							...
							if (Item.getIdFromItem(item.getItem())!=0){
								if(item.hasDisplayName()){
									...
									output.append("\t\tSlot;"+i+";"+Item.getIdFromItem(item.getItem())+";("+item.getUnlocalizedName()+");"+item.func_190916_E()+";"+item.getItemDamage()+";"+item.getDisplayName()+";"+item.getEnchantmentTagList()+"\n");
								}else{
									...
									output.append("\t\tSlot;"+i+";"+Item.getIdFromItem(item.getItem())+";("+item.getUnlocalizedName()+");"+item.func_190916_E()+";"+item.getItemDamage()+";null;"+item.getEnchantmentTagList()+"\n");
								}
							}
						}
						output.append("\t\t-\n");
